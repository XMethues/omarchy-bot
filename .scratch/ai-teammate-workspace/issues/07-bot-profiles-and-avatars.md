...
- [x] The combined Bot avatar and name in the conversation Header opens a Profile BottomSheet that identifies the immutable Agent as read-only context while allowing name and Instructions updates.
