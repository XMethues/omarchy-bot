...
- [x] The combined Bot avatar and name in the conversation Header toggles a right-side Astryx `LayoutPanel` at every window width; it identifies the immutable Agent as read-only context while allowing name and Instructions updates.
